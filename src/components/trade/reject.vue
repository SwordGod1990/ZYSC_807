<template>
  <div>
    ...
    <div class="details_mainBody">
      <div class="details_back"><button class="reject_return" @click="returnHomePage">返回</button></div>
      <div class="details_orderInfoAndStatus">
        <div class="details_orderInfoAll">
          ...
          <div class="details_buyTime"><span>取消原因：</span><span>{{this.detailsDrugInfo.refuseReason}}</span></div>
        ...
        <div class="details_orderStatus">
          ...
          <span class="details_currentStatus">{{currentStatus}}</span>
        </div>
      </div>
      <div class="details_orderDetails">
        ...
        <!--<div class="details_deliveryTime"><span>发货时间：</span><span>2018-05-24 10:09</span></div>-->
        <!--<div class="details_retrievePerson"><span>发货人:</span><span>张晓华</span></div>-->
        <!--<div class="details_retrieveTele"><span>联系电话:</span><span>13832678787</span></div>-->
      </div>
    </div>
  </div>
</template>
  ...
  export default {
    ...
    computed: {
      currentStatus:function () {
        if(this.detailsDrugInfo.status == "3"){
          return "订单状态：已取消";
        }else{
          return "订单状态异常";
        }
