    ...
    <div class="details_orderDetails">
      <div class="add_nameAndCode">
        <div class="add_name">
          ...
          <input type="text" placeholder="" value="阿莫西林胶囊" v-model="inputDrugName">
        </div>
        <div class="add_code">
      ...
      <div class="goods_firmAndType">
        <div class="goods_firm">
          ...
          <input type="text" placeholder="请输入药品生产企业" v-model="inputDrugFirm">
        </div>
        <div class="goods_type">
          ...
          <div class="goods_usageType">
            ...
            <ul v-show="type">
              <li @mouseenter='mouseenterUnit(index)' @mouseleave='mouseleaveType' :class='{hoverStyle:itemHoverIndexUnit==index}' @click='inputTypeM($event)' v-for="(medicinalDosage,index) in this.medicinalDosageArray" :key="index">{{medicinalDosage.basicPackName}}</li>
            </ul>
          </div>
        </div>
      </div>
      <div class="goods_sizeAndPack">
        <div class="add_code">
          ...
          <input type="text" placeholder="请输入药品规格" v-model="inputPackageNum">
        </div>
        <div class="add_code">
      ...
      <div class="goods_usageAndTimes">
        <div class="goods_usage">
          ...
          <div class="goods_usageUses">
            ...
            <ul v-show="use">
              <li @mouseenter='mouseenterNum(index)' @mouseleave='mouseleaveUse' :class='{hoverStyle:itemHoverIndexNum==index}' @click='inputUseM($event)' v-for="(direction,index) in this.directionArray" :key="index">{{direction.basicPackName}}</li>
            </ul>
          </div>
          <div class="goods_usageNum">
            <span><input type="text" readonly="readonly" @click='num = !num' v-model='inputNum' placeholder="请选择用量"></span>
            <ul v-show="num">
              <li @mouseenter='mouseenterUsage(index)' @mouseleave='mouseleaveNum' :class='{hoverStyle:itemHoverIndexUsage==index}' @click='inputNumM($event)' v-for="(singleDosage,index) in this.frequentnessArray" :key="index">{{singleDosage.basicPackName}}</li>
            </ul>
          </div>
        </div>
        <div class="goods_times"><label>每次：</label>
          ...
          <div class="goods_usageUnits">
            ...
            <ul v-show="unit">
              <li @mouseenter='mouseenterType(index)' @mouseleave='mouseleaveUnit' :class='{hoverStyle:itemHoverIndexType==index}' @click='inputUnitM($event)' v-for="(frequentnessUnit,index) in this.frequentnessUnitArray" :key="index">{{frequentnessUnit.basicPackName}}</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    methods: {
      ...
      ascertain() {
        ...
        if (this.activityForward == this.$route.query.activityForward) {
          this.$router.push({name: 'creatingActivities', query: {returnActivityAdd: "returnActivityAdd"}});
        } else {
